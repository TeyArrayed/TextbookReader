...
public class textBox extends JFrame {
    ...
    public static void textSubmitted() {
        ...
        timer = new javax.swing.Timer(3000 / (int) (Double.parseDouble(speedDisplay.getText())), e -> {
    ...
    public static void main(String[] args) {
        mainFrame = new JFrame("TextbookReader");
        ...
        cancelButton.setVisible(false);
        cancelButton.setBounds(25, 250, 100, 30);
        cancelButton.addActionListener(e -> {
                textCancelled();
        });

        //Repeat button to repeat the paragraph again
        repeatButton = new JButton("?");
        repeatButton.setVisible(false);
        repeatButton.setBounds(195, 250, 50, 30);
        repeatButton.addActionListener(e -> {
            textSubmitted();
        });

        //Pause button to pause the reading
        pauseButton = new JButton("||");
        pauseButton.setVisible(false);
        pauseButton.setBounds(135, 250, 50, 30);
        ...
        decreaseSpeed.setVisible(false);
        decreaseSpeed.setBounds(260, 250, 40, 30);
